...
def find_top_n_relevant_docs(query_embedding, embeddings, n=5):
...
question = st.text_input('Ask a question about Parkinson\'s disease:')

if st.button('Search Answer'):
    if question:
        query_embedding = get_query_embedding(question, st_model)
        top_docs_indices = find_top_n_relevant_docs(query_embedding, embeddings, n=5)
